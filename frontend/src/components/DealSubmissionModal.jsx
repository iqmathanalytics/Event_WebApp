      ...
      {open ? (
        ...
        >
          ...
          <motion.form
            ...
            className="popup-modal relative flex h-[min(90vh,820px)] w-full max-w-3xl flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl"
          >
