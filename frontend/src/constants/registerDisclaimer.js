...
export const REGISTRATION_DISCLAIMER_PARAGRAPHS = [
  "By registering for an account on Book My Tickets, you confirm that the information you provide is accurate and that you are authorized to use the email address and telephone number (if provided) associated with this registration.",
  ...
  "Your relationship with Book My Tickets is governed by our Terms of Service and Privacy Policy, which describe how the platform operates and how personal data is collected, used, and protected. Those documents, once published on this site, form part of your agreement with us."
];
