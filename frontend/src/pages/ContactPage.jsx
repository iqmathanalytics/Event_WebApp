  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden space-y-5">
        ...
        <motion.div
          layout
          className="overflow-hidden rounded-3xl border border-slate-200/90 bg-white shadow-soft"
        >
          <div className="border-b border-slate-100 bg-gradient-to-br from-slate-50 to-white px-5 py-4">
            <h2 className="text-base font-semibold text-slate-900">Message us</h2>
          ...
          <form onSubmit={onSubmit} className="space-y-4 p-5">
            ...
            <motion.button
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-brand-600 py-3.5 text-sm font-semibold text-white shadow-lg shadow-brand-600/25 transition hover:bg-brand-700 disabled:cursor-not-allowed disabled:opacity-70"
            >
              {submitting ? (
                <>
