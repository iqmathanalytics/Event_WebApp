...
CREATE TABLE IF NOT EXISTS events (
  ...
  seating_mode ENUM('general','reserved') NOT NULL DEFAULT 'general',
  seatsio_chart_key VARCHAR(80) NULL,
  seatsio_event_key VARCHAR(80) NULL,
  ...
  service_fee_enabled TINYINT(1) NOT NULL DEFAULT 0,
  service_fee_type ENUM('percent','fixed') NOT NULL DEFAULT 'percent',
  service_fee_value DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  platform_fee_enabled TINYINT(1) NOT NULL DEFAULT 0,
  platform_fee_type ENUM('percent','fixed') NOT NULL DEFAULT 'percent',
  platform_fee_value DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  vendor_code_enabled TINYINT(1) NOT NULL DEFAULT 0,
  vendor_code VARCHAR(40) NULL,
  vendor_discount_type ENUM('percent','fixed_amount') NOT NULL DEFAULT 'percent',
  vendor_discount_value DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  coupon_codes_enabled TINYINT(1) NOT NULL DEFAULT 1,
  show_on_events_page TINYINT(1) NOT NULL DEFAULT 1,
