...
const lines = [
  ...
  `FRONTEND_URL=${opt("FRONTEND_URL", "https://www.bookmytickets.us")}`,
  `PUBLIC_APP_URL=${opt("PUBLIC_APP_URL", "https://www.bookmytickets.us")}`,
  `PUBLIC_API_URL=${opt("PUBLIC_API_URL", `${opt("PUBLIC_APP_URL", "https://www.bookmytickets.us")}/api`)}`,
  "",
  ...
  "",
  `# Weekly organizer + shared-analytics digest (Monday 09:00 APP_TIMEZONE)`,
  `DAILY_SUMMARY_ENABLED=${opt("DAILY_SUMMARY_ENABLED", opt("WEEKLY_SUMMARY_ENABLED", "true"))}`,
  `DAILY_SUMMARY_HOUR=${opt("DAILY_SUMMARY_HOUR", opt("WEEKLY_SUMMARY_HOUR", "9"))}`,
  `DAILY_SUMMARY_CHECK_MS=${opt("DAILY_SUMMARY_CHECK_MS", opt("WEEKLY_SUMMARY_CHECK_MS", "900000"))}`,
  `WEEKLY_SUMMARY_ENABLED=${opt("WEEKLY_SUMMARY_ENABLED", "true")}`,
  `WEEKLY_SUMMARY_HOUR=${opt("WEEKLY_SUMMARY_HOUR", "9")}`,
  `WEEKLY_SUMMARY_CHECK_MS=${opt("WEEKLY_SUMMARY_CHECK_MS", "900000")}`,
  "",
  ...
  "",
  `SEATSIO_SECRET_KEY=${opt("SEATSIO_SECRET_KEY")}`,
  `SEATSIO_WORKSPACE_KEY=${opt("SEATSIO_WORKSPACE_KEY")}`,
  `SEATSIO_REGION=${opt("SEATSIO_REGION", "na")}`,
  "",
